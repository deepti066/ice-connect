            ...
            <footer>
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                        ...
                        <ul className="text-md">
                        <li className="mb-2">
                            <Link to="/broadband" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Broadband</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="/bundle" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">OTT Bundle Subscription</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="/corporate" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Corporate internet services with dedicated FTTO</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="/internet" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Enterprise internet service with live IP'S and FTTO</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="/Tv" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">TV and streaming</Link>
                        </li>
                        </ul>
                    </div>
