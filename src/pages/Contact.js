...
const Contact = () => {
    useDocTitle('Aryahi Optinet - Send us a message')
    ...
    return (
        <>
            ...
            <div id='contact' className="flex justify-center items-center w-full bg-gradient-to-br from-gray-800 via-blue-900 to-black py-12 lg:py-24 ">
                ...
                <form onSubmit={sendEmail}>
                            ...
                            <div className="flex flex-col text-white">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-3/4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-400">Sikaria Compound, Christian Basti, G.S. Road,
                                            Guwahati- 781005</p>
                                    </div>
                                </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">8055384406</p>
                            ...
                            <div className='mt-5'>
                                ...
                                <p className="text-gray-400">info@iceconnect.com</p>
                            </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <a href="https://www.linkedin.com/company/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8  mx-1 text-center pt-1">
